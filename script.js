...
button_space.style.backgroundColor = 'rgb(185, 185, 185)'
...
const styleClass = document.createTextNode('.act {width: 5%;display: block;height: 55px;margin-right: 1%;margin-left: 0%;color: rgb(255, 141, 0);border-radius: 7px;box-shadow: rgba(0, 0, 0, 0.75) 0px 2px 5px 0px;cursor: pointer;font-family: Play;text-align: center;background-color:red !important;} .button {width: 5%;display: block;height: 55px;margin-right: 1%;margin-left: 0%;color: rgb(255, 141, 0);border-radius: 7px;box-shadow: rgba(0, 0, 0, 0.75) 0px 2px 5px 0px;cursor: pointer;font-family: Play;text-align: center;background-color: rgb(74, 74, 74)}')
style.appendChild(styleClass)
document.body.append(style);


input_area.addEventListener('click',(event)=>{ //меняется цвет кнопок при нажатии
    input_area.querySelectorAll('li').forEach(el=>el.classList.remove('act'));
    event.target.classList.add('act')
   
    if (input_area.classList.length == 2 ) {
        input_area.classList.remove('act')
    }
